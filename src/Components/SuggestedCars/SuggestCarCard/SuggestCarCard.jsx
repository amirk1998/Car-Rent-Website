...
const SuggestCarCard = ({
  ...
  return (
    <div>
      {/* Mobile View */}
      <div className='w-[327px] h-60 bg-primary-000 rounded-xl flex flex-col p-4 md:hidden '>
        {/* Title , Type and Like */}
        ...
        {/* Car Image */}
        <div className='flex items-center justify-between'>
          <div className='mt-8 w-[142px] h-16 ml-[14px] mr-5'>
          ...
          <div className='flex flex-col gap-y-4 '>
            ...
            <div className='flex items-center gap-x-1'>
              ...
              <p className='text-secondary-300 font-medium text-xs flex items-center'>
            ...
            <div className='flex items-center gap-x-1'>
              ...
              <p className='text-secondary-300 font-medium text-xs flex items-center gap-x-1'>
      ...
      {/* Desktop View */}
      <div className='hidden lg:w-[304px] lg:h-96 bg-primary-000 rounded-xl lg:flex lg:flex-col p-4 '>
        {/* Title , Type and Like */}
        <div className='flex flex-col gap-y-1'>
          <div className='flex items-center justify-between'>
